        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-white/90">Welcome back! Here&apos;s what&apos;s happening with your courses today.</p>
            </div>
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <StatsCard title="Total Courses" value="24" subtitle="4 Active" icon={BookOpen} iconColor="text-white" />
            <StatsCard
            ...
            />
            <StatsCard title="Teachers" value="18" subtitle="2 On leave" icon={GraduationCap} iconColor="text-white" />
            <StatsCard title="Classes" value="32" subtitle="8 Scheduled today" icon={School} iconColor="text-white" />
          </div>
        </div>
      </div>
