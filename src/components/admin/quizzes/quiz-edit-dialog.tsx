...
import { Quiz, updateQuiz, getQuizById, Question, QuestionOption } from '@/services/quizService'
...
export function QuizEditDialog({
  ...
  const fetchQuizDetails = async () => {
    ...
    try {
      const quizDetail = await getQuizById(quiz.id)
      setCourseId(quizDetail.courseId.toString())
      setTitle(quizDetail.title)
      setTimeLimitSeconds('3600') // Default since API doesn't return this
      setRandomizeQuestions(quizDetail.randomizeQuestions || false)
      setRandomizeOptions(quizDetail.randomizeOptions || false)
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>Update quiz information and questions</DialogDescription>
        </DialogHeader>
